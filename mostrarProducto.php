...
<body>
    <div class="card">
        ...
        try {
            ...
            if (isset($_GET['id'])) {
                ...
                if ($producto) {
                    ...
                    echo "<a href='data:image/jpeg;base64," . base64_encode($producto['imagen']) . "' download='producto.jpg' class='btn btn-light'>Descargar Imagen</a>";
                } else {
        ...
        ?>
        <a href="mostrarVehiculosUsuario.php" class="btn btn-info">Volver a la tabla</a><br />
    </div>
</body>
</html>
